                ...
                <div class="col-md-4">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col d-flex justify-content-end">
                            ...
                            <button type="button" id="btnFinalizar" class="btn btn-success mr-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="finalizarPedido(<?= $dados['idVendedor'] ?>);">
                                Finalizar Pedido
                            </button>
